...
class NewList:
    ...
    def select_game(self):
        self.pop.set_title('Add list: Select game')
    ...
    def add_host_and_port(self, button, game):
        ...
        self.pop.set_title('Add list: Hostname and port')
        ...
        button.connect('clicked', self.save_list, self.hostname.get_text, self.port.get_text, game)
        button.set_size_request(10, 10)
        self.box_outer.pack_start(button, True, True, 0)
    ...
    def save_list(self, button, hostname, port, game):
        self.load.add_new_list(hostname(), int(port()), game)
        self.pop.destroy()
